...
Our software provides the user with an interface to query for similar loops using a slider interface to specify a range of tempo, timbral and rhythmic distances. We believe this application has the potential to significantly reduce the amount of time spent navigating large libraries of audio loops.
